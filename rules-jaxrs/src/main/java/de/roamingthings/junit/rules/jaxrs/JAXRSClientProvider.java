...
public class JAXRSClientProvider implements TestRule {
    ...
    public final static JAXRSClientProvider buildWithURI(String systemPropertyKey, String defaultUri) {
        return buildWithURI(System.getProperty(systemPropertyKey, defaultUri));
    }
    ...
    public WebTarget addPath(String path) {
